...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_1ed0855bf07f6dca, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1ed0855bf07f6dca, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "helloworld.helloworld.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "helloworld.helloworld.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("helloworld/helloworld/tx.proto", fileDescriptor_1ed0855bf07f6dca) }

var fileDescriptor_1ed0855bf07f6dca = []byte{
	// 322 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcb, 0x48, 0xcd, 0xc9,
	0xc9, 0x2f, 0xcf, 0x2f, 0xca, 0x49, 0xd1, 0x47, 0x62, 0x96, 0x54, 0xe8, 0x15, 0x14, 0xe5, 0x97,
	...
	0xd8, 0xc0, 0x71, 0x63, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x68, 0xb6, 0xd9, 0xf1, 0x55, 0x02,
	0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/helloworld.helloworld.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.helloworld.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "helloworld.helloworld.Msg",
	...
	Metadata: "helloworld/helloworld/tx.proto",
}
