...
import (
	...
	"github.com/username/helloapp/app"
)
...
// genesisCommand builds genesis-related `helloappd genesis` command. Users may provide application specific commands as a parameter
